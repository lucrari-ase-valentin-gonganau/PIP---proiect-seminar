...
namespace ProiectIngineriaProgramarii.ExcelAddin
{
    public class RapoarteExcelGenerator
    {
        ...
        private void FormatareaTabelului(Excel.Worksheet worksheet, int numarFacturi)
        {
            ...
            worksheet.Columns["B:B"].ColumnWidth = 12;
            worksheet.Columns["C:C"].ColumnWidth = 25;
            worksheet.Columns["D:D"].ColumnWidth = 15;
            worksheet.Columns["E:E"].ColumnWidth = 12;
            worksheet.Columns["F:F"].ColumnWidth = 15;
        }
        ...
        public void GenereazaRaportProduse(List<Produs> produse, string caleFisier)
        {
            ...
            try
            {
                ...
                totalRange.Font.Bold = true;
                totalRange.Interior.Color = Excel.XlRgbColor.rgbYellow;
                worksheet.Cells[currentRow + 1, 5].NumberFormat = "#,##0.00";
        ...
        public void GenereazaRaportClienti(List<Client> clienti, string caleFisier)
        {
            ...
            try
            {
                ...
                worksheet.Cells[1, 1] = "RAPORT CLIENȚI";
                worksheet.Range["A1", "F1"].Merge();
                worksheet.Range["A1"].Font.Size = 16;
                worksheet.Range["A1"].Font.Bold = true;
                worksheet.Range["A1"].HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                ...
                worksheet.Cells[startRow, 6] = "Data Înregistrare";
                ...
                worksheet.Columns["C:C"].ColumnWidth = 20;
                worksheet.Columns["D:D"].ColumnWidth = 30;
                worksheet.Columns["E:E"].ColumnWidth = 15;
                worksheet.Columns["F:F"].ColumnWidth = 18;

                worksheet.Cells[currentRow + 1, 1] = $"Total clienți: {clienti.Count}";
                worksheet.Range[$"A{currentRow + 1}"].Font.Bold = true;
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Eroare la generarea raportului clienți: {ex.Message}", ex);
            }
        }
